...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . ($context["icon_position"] ?? null))) : ("")));
  ...
  ";
    ...
    {
        return new Twig_Source("", "themes/contrib/bootstrap/templates/input/input--button--split.html.twig", "/Users/Thomas/Dropsolid/ownprojects/duivendagboek/web/themes/contrib/bootstrap/templates/input/input--button--split.html.twig");
    }
}
